...
public class SendSmsDriver extends AsyncTask<User, Void, String> {
    private static final String TAG =
            "TAG :: " + SendSmsDriver.class.getSimpleName() + " :: ";
...
private DatabaseReference work_in_progress;
    ...
    public SendSmsDriver(Activity activity, String employee_name, String employee_phone, DatabaseReference work_in_progress) {
    ...
    protected String doInBackground(User... users) {
        driver driv = (driver) users[0];
        Log.d(TAG, "doInBackground :: " + driv.getPhone());
        String employer_name = driv.getName().toUpperCase();
        String employer_phone = driv.getPhone();
...
//                conn.disconnect();
    ...
    protected void onPostExecute(String s) {
        ...
        Toast.makeText(activity, "Mechanic has been notified, kindly wait for their response.",
