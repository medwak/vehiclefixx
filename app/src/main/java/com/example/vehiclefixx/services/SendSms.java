...
import com.example.vehiclefixx.data.User;
...
public class SendSms extends AsyncTask<User, Void, String> {
    ...
    private  String time;
    private final String mechanic_id;
    private final String driver_id;
    private final LatLng pickupLocation;
    private final DatabaseReference  mechanics_notified;
    ...
    public SendSms(Activity activity, String employer_name, String employer_id, String employee_id,
        ...
        this.driver_name = employer_name.toUpperCase();
        this.driver_id = employer_id;
        this.mechanic_id = employee_id;
        this.activity = activity;
        this.pickupLocation = pickupLocation;
        this.mechanics_notified = employees_notified;
        this.marker = marker;
        try {
    ...
    protected String doInBackground(User... users) {
        mechanic mech = (mechanic) users[0];
        Log.d(TAG, "doInBackground :: " + mech.getPhone());
        String employee_name = mech.getName().toUpperCase();
        String employee_phone = mech.getPhone();
...
//                conn.disconnect();
    ...
    protected void onPostExecute(String s) {
        ...
        Toast.makeText(activity, "Driver has been notified, kindly wait for their response.",
    ...
    private void updateEmployee() {
        final GeoFire geoFireNotified = new GeoFire(mechanics_notified);
        ...
        if(mechanic_id==null){
            ...
            Log.d(TAG, "geoFireNotified.updateEmployeeRef :: getId "+ mechanic_id);
        }
        geoFireNotified.setLocation(mechanic_id, new GeoLocation(pickupLocation.latitude,
