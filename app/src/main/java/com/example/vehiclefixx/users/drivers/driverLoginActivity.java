...
import com.google.firebase.database.FirebaseDatabase;
    ...
    public class driverLoginActivity extends AppCompatActivity {
        private static final String TAG = "TAG :: " + driverLoginActivity.class.getSimpleName() + " " +
                ":: ";
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            this.setTitle(getResources().getString(R.string.driver_login_title));
                            ...
                            new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    ...
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(driverLoginActivity.this, "Incorrect email or password.", Toast.LENGTH_LONG).show();
                                }
                            })
