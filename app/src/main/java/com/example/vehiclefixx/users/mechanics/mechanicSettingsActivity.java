...
public class mechanicSettingsActivity extends AppCompatActivity {
    private static final String TAG =
            "TAG :: " + mechanicSettingsActivity.class.getSimpleName() + " :: ";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firebaseAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    mechanicSettingsActivity.this.setTitle("Profile : " + user.getDisplayName().toUpperCase());
                    ...
                    Intent intent = new Intent(mechanicSettingsActivity.this,
    ...
    private void saveUserInformation() {
        ...
        if (radioButton == null) {
            vehicleFixx_Settings.showAlert(this, "Select Category", "FreeLance or Repairs");
            return;
        }
        if (filePath == null) {
            vehicleFixx_Settings.showAlert(this, "Image Required", "Select profile Image");
            return;
        }
