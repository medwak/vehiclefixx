...
public class mechanicLoginActivity extends AppCompatActivity {
    private static final String TAG = "TAG :: " + mechanicLoginActivity.class.getSimpleName() + " " +
            ":: ";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle(getResources().getString(R.string.mechanic_login_title));
...
//                                            loader.dismiss();
                                            ...
                                            Intent intent = new Intent(mechanicLoginActivity.this, com.example.vehiclefixx.users.mechanics.mechanicMapActivity.class);
...
//        mAuth.addAuthStateListener(firebaseAuthListener);
        ...
        as_an_employer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(mechanicLoginActivity.this,
        ...
        registration.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(mechanicLoginActivity.this,
                        com.example.vehiclefixx.users.mechanics.mechanicRegistrationActivity.class));
            }
        });
    ...
    private void performLogin() {
        ...
        mAuth.signInWithEmailAndPassword(email_txt, password_txt)
                .addOnCompleteListener(mechanicLoginActivity.this,
                        new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (task.isSuccessful()) {
                                    ...
                                    Toast.makeText(mechanicLoginActivity.this, "Incorrect email or password.", Toast.LENGTH_LONG).show();
                            }
                        })
                .addOnFailureListener(mechanicLoginActivity.this, new OnFailureListener() {
                    @Override
