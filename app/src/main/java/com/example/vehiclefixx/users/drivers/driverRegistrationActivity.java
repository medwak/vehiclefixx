...
public class driverRegistrationActivity extends AppCompatActivity  {
    private static final String TAG =
            "TAG :: " + driverRegistrationActivity.class.getSimpleName() + " :: ";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle(getResources().getString(R.string.driver_registration_title));
        ...
        login_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(driverRegistrationActivity.this,
                        driverLoginActivity.class));
            }
        });
        ...
        TextView as_an_employee = findViewById(R.id.as_an_mechanic);
        as_an_employee.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(driverRegistrationActivity.this,
                        mechanicRegistrationActivity.class));
            }
        });
    }
                ...
                .addOnCompleteListener(driverRegistrationActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (!task.isSuccessful()) {
                            ...
                            Toast.makeText(driverRegistrationActivity.this, "Registration Failed: \n" + error, Toast.LENGTH_SHORT).show();
                            loader.dismiss();
                            ...
                            userDatabaseRef
                                    ...
                                    .addOnCompleteListener(driverRegistrationActivity.this,
                                            new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    if (task.isSuccessful()) {
                                                        Toast.makeText(driverRegistrationActivity.this, "your have successfully registered", Toast.LENGTH_SHORT).show();
                                                        Log.e(TAG, "onCancelled", task.getException());
                                                        loader.dismiss();
                                                        Intent intent =
                                                                new Intent(driverRegistrationActivity.this, driverMapActivity.class);
                                                        startActivity(intent);
                                                        finish();
                                                        ...
                                                        loader.dismiss();
                                                        Toast.makeText(driverRegistrationActivity.this, "Details upload Failed: " + error, Toast.LENGTH_SHORT).show();
                                                    }
                                                }
                                            });
                            loader.dismiss();
