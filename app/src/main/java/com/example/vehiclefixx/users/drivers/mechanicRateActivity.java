...
import com.example.vehiclefixx.services.FetchAsync;
import com.example.vehiclefixx.services.FetchMechanicAsync;
import com.example.vehiclefixx.services.RateAsync;
...
public class mechanicRateActivity extends AppCompatActivity {

    private static final String TAG =
            "TAG :: " + mechanicRateActivity.class.getSimpleName() + " :: ";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FetchMechanicAsync fetchmechanicAsync = new FetchMechanicAsync(this, name, phone, skill,
                service,
                ratingBar, confirm_btn, employee);
       fetchmechanicAsync.execute();
        confirm_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RateAsync fetchAsync = new RateAsync(mechanicRateActivity.this, userInfo, employee_rate);
